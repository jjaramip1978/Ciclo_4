			...
			<div className="col">
				<div className="card mb-4 rounded-3 shadow-sm">
					<div className="card-header py-3">
						<h5 className="my-0 fw-normal">{props.Habilidad}</h5>               {/* props.Habilidad que estoy mandando desde el componente ListProfesion.jsx */}
					</div>
					...
					<div className="card-body">
						...
						<h1 className="card-title pricing-card-title sm">												{/* props.Profesion que estoy mandando desde el componente ListProfesion.jsx */}
							{props.Profesion}
